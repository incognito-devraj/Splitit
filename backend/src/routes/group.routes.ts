...
router.patch('/settings',        requireGroup, requireAdmin, validate(updateGroupSettingsSchema), ctrl.updateGroupSettings);
...
router.get('/discover',          validate(discoverGroupsSchema),      ctrl.discoverGroups);
